...
# Part 2 - monkeys throwing stuff around.  but a lot more than part 1
#
...
# get the lcm of all the divisors the monkeys use.
lcmFactor=1
for m in troop:
...
while round<MAX_ROUNDS:
    ...
    for mnum,m in enumerate(troop):
        ...
        while m.items:
            ...
            # instead of dividing by 3 as in part 1, we do mod lcm of all the 
            # monkey's divisors to keep the magnitude under control
            item = item % lcmFactor
